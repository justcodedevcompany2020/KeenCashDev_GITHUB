...
export const Resive  = () => {
    return <ScrollView style = {Gstyles.home}>
        ...
        <View style ={{justifyContent:'center',alignItems:'center',marginVertical:40}}>
            <Svgs title={'QRCode'} />
            <Text style = {{color:'#8A8A8A',fontSize:12,fontWeight:300,marginTop:10,}}>Your wallet</Text>
        </View>
        <View>
            <Text style = {{color:'#FFFFFF',fontWeight:300,fontSize:15,textAlign:'center',marginBottom:25,marginHorizontal:20}}>EQAQxrU1G0D9-FQ3h1mO7o5qex-JJWvrAE82QnezDHqrS16B</Text>
        </View>
        <View>
